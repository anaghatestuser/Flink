...
* `historyserver.lazy.fetch.executor.individual.pool-size` (default: `4`) — The size of the high-priority thread pool dedicated to fetching individual archives on demand (e.g., when a user accesses them).
